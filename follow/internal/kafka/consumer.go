...
func StartConsumer(brokers []string, topic string, followService core.FollowService, logger *platform.Logger) {
	...
	for {
		...
		case msg := <-partitionConsumer.Messages():
			...
			err = followService.CreateCacheUser(ctx, user.ID, user.Username, user.Name)
			if err != nil {
