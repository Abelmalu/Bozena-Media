...
const file_Auth_proto_auth_proto_rawDesc = "" +
	...
	"\x0eRefreshHandler\x12\x1b.authservice.RefreshRequest\x1a\x1c.authservice.RefreshResponseB\fZ\n" +
	"./proto/pbb\x06proto3"
...
var file_Auth_proto_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
var file_Auth_proto_auth_proto_depIdxs = []int32{
	...
	8, // 2: authservice.AuthService.Logout:input_type -> google.protobuf.Empty
	6, // 3: authservice.AuthService.RefreshHandler:input_type -> authservice.RefreshRequest
	...
	5, // 6: authservice.AuthService.Logout:output_type -> authservice.LogoutResponse
	7, // 7: authservice.AuthService.RefreshHandler:output_type -> authservice.RefreshResponse
