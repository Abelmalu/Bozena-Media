...
func (c *postServiceClient) GetUserPosts(ctx context.Context, in *GetUserPostRequest, opts ...grpc.CallOption) (*GetUserPostResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func _PostService_GetUserPosts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).GetUserPosts(ctx, req.(*GetUserPostRequest))
	}
	return interceptor(ctx, in, info, handler)
}
